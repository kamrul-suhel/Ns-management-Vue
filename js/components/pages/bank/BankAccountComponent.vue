                    ...
                    <v-card>
                        ...
                        <v-card-actions>
                            ...
                            <v-btn
                                    ...
                                    raised
                                    color="dark"
                                    @click="onAddBank()">{{ editedIndex <= 0 ? 'Create Account' : 'Update Account'}}
                            </v-btn>
                        </v-card-actions>
                    </v-card>
                </v-flex>
        ...
        <v-dialog v-model="deleteDialog"
            ...
            <v-card color="error">
                <v-card-text>
                    ...
                    <p class="text-xs-center">Are you sure you want to delete {{deleteAccount.name}}</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            async onAddBank() {
                let url = `/api/banks/${this.$route.params.id}/accounts`;
                this.editedItem.bank_id = this.$route.params.id;

                if (this.editedIndex >= 0) {
                    url = `/api/banks/${this.$route.params.id}/accounts/` + this.editedItem.id
                }
            ...
            async initialize() {
                const response = await axios.get(`/api/banks/${this.$route.params.id}/accounts`);
            ...
            async confirmDeleteBank() {
                const url = `/api/banks/${this.deleteAccount.bank_id}/accounts/${this.deleteAccount.id}`
                const response = await axios.delete(url)

                const index = this.accounts.indexOf(this.deleteAccount)
